...
Gem::Specification.new do |spec|
  ...
  spec.description   = %q{Mmultilogger enables you to log to different places with different configuration as long as the loggers impplement the same interface.}
